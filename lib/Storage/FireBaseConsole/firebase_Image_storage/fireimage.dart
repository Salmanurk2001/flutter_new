...
void main() async {
  ...
  await Firebase.initializeApp(
      options: const FirebaseOptions(
          ...
          storageBucket: "fir-operation-new.appspot.com"));
  runApp(MaterialApp(
    home: Fire_Image_storage(),
  ));
}
class Fire_Image_storage extends StatefulWidget {
  @override
  State<Fire_Image_storage> createState() => _Fire_Img_storageState();
}

class _Fire_Img_storageState extends State<Fire_Image_storage> {
